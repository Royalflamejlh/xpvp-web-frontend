...
export type MDXKit = MDXDocument & {
  tags?: string[]
}
 ...
 *
 * @param {MDXDocument[]} allKits
 * @return {*}
 */
export function sortPosts<T extends MDXDocument>(allKits: T[]) {
  return allKits
}
 ...
 * @deprecated
 * @param {MDXBlog[]} allKits
 * @return {*}
 */
export function sortedBlogPost(allKits: MDXDocument[]) {
  return allKits
}
